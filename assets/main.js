    ...
    if (peso1 === 0 || peso2 === 0 || preco1 === 0 || preco2 === 0) {
        ...
        peso.forEach(i => {
            if (i.textContent === 'Gramas (g)') {
                ...
                campoResultado[0].innerHTML = `O preço por grama do primeiro produto (com ${peso1} gramas) é de <br>${precoPorPesoProduto1.toFixed(2).padEnd(2, '0')} centavos`

                campoResultado[1].innerHTML = `O preço por grama do segundo produto (com ${peso2} gramas) é de <br>${precoPorPesoProduto2.toFixed(2).padEnd(2, '0')} centavos`
